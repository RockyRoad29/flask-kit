# -*- coding: utf-8 -*-
#
# Flask Kit documentation build configuration file, created by
...
latex_documents = [
  ('index', 'FlaskKit.tex', u'Flask Kit Documentation',
   u'rockyroad', 'manual'),
]
...
man_pages = [
    ('index', 'flaskkit', u'Flask Kit Documentation',
     [u'rockyroad'], 1)
]
...
texinfo_documents = [
  ('index', 'FlaskKit', u'Flask Kit Documentation',
   u'rockyroad', 'FlaskKit', 'One line description of project.',
   'Miscellaneous'),
]
